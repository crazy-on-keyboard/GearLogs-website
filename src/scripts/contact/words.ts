...
export const WORDS: Record<Lang, Words> = {
  ...
  he: {
    ...
    messageHelp: {
      ...
      purchase: 'כמה חשבונות תצטרכו, ובחיוב חודשי או שנתי?',
    ...
    errors: {
      ...
      email: {
        ...
        shape: 'הזינו כתובת אימייל, לדוגמה name@company.com',
      ...
      message: {
        ...
        long: 'ההודעה ארוכה ב־{n} תווים מהמותר. לא קיצרנו אותה.',
